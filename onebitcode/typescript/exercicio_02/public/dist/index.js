...
function objectPlanet(namePlanet, coordinates, situation) {
    const Planet = {
        namePlanet,
        coordinates,
        situation,
...
function situationPlanet(namePlanet) {
    let userOption;
    do {
...
function newSituation(namePlanet) {
...
function addSatellites(namePlanet, satellites) {
    const search = findPlanet(namePlanet);
    if (search) {
...
function removeSatellites(namePlanet) {
    const search = findPlanet(namePlanet);
    if (search) {
...
function firstMenuOption() {
    ...
    const coordFinal = [coordX, coordY, coordZ, coordT];
